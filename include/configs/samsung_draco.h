 ...
 *
 * Configuration for Samsung Exynos 5433-based Draco/DracoR boards.
 * Parts were derived from Hikey board configuration.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef __SAMSUNG_DRACO_H
#define __SAMSUNG_DRACO_H

#include <linux/sizes.h>

#define CONFIG_IDENT_STRING		"\nSamsung Exynos5433 Draco"

#define CONFIG_OF_LIBFDT

#define CONFIG_TPL_SAMSUNG_DRACO
...
#define CONFIG_EXTRA_ENV_SETTINGS	"dfu_alt_info=kernel part 0 9 offset 0x400;rootfs part 0 18;system-data part 0 19;user part 0 21\0" \
					...
					"boarddetect=if itest.l *0x138000b4 == 0x0063f9ff; then setenv board dracor; elif itest.l *0x138000b4 == 0x0059f9ff; then setenv board draco; else setenv board unknown; fi; echo Detected $board board\0" \
