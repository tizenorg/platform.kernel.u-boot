...
const struct pad_conf_entry core_padconf_array[] = {
	...
	{GPMC_AD8, (PTU | IEN | OFF_EN | OFF_PD | OFF_IN | M3)},	/* 3_TOUCH_INT */
	{GPMC_AD9, (PTU | IEN | OFF_EN | OFF_PD | OFF_IN | M3)},	/* PS_VOUT_18 */
	{GPMC_AD10, (PTU | OFF_EN | OFF_PD | OFF_IN | M3)},		/* CP_USB_ON */
	{GPMC_AD11, (PTU | OFF_EN | OFF_PD | OFF_IN | M3)},		/* MLCD_RST */
	{GPMC_AD12, (PTD | OFF_EN | OFF_PD | OFF_IN | M3)},		/* CP_ON */
	{GPMC_AD13, (PTD | OFF_EN | OFF_PD | OFF_IN | M3)},		/* PS_ON */
	{GPMC_AD14, (PTU | IEN | M3)},					/* OLED_DET */
	{GPMC_AD15, (PTU | IEN | M3)},					/* TA_CURRENT_SEL */
	{GPMC_A16, (M3)},						/* gpio_40 */
	{GPMC_A17, (PTD | M3)},						/* gpio_41 */
	{GPMC_A18, (PTU | IEN | OFF_EN | OFF_PD | OFF_IN | M1)},	/* kpd_row6 */
	{GPMC_A19, (PTD | OFF_EN | OFF_PD | OFF_IN | M3)},		/* gpio_43 */
	{GPMC_A20, (IEN | M3)},						/* gpio_44 */
	{GPMC_A21, (M3)},						/* gpio_45 */
	{GPMC_A22, (OFF_EN | OFF_PD | OFF_IN | M1)},			/* kpd_col6 */
	{GPMC_A23, (PTU | OFF_EN | OFF_PD | OFF_IN | M3)},		/* UART_SEL */
	...
	{CSI21_DX3, (IEN | M3)},					/* HW_REV3 */
	{CSI21_DY3, (IEN | M3)},					/* HW_REV2 */
	{CSI21_DX4, (IEN | M3)},					/* HW_REV1 */
	{CSI21_DY4, (IEN | M3)},					/* HW_REV0 */
...
const struct pad_conf_entry wkup_padconf_array[] = {
	...
	{PAD1_SIM_CD, (PTU | IEN | M3)},	/* EXT_WAKEUP */
