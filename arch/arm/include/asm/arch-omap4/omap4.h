...
#define CONTROL_USBOTGHS_CONTROL	(CTRL_BASE + 0x33c)
...
/* GPIO */
#define GPIO1_BASE		(OMAP44XX_L4_WKUP_BASE + 0x10000)
#define GPIO2_BASE		(OMAP44XX_L4_PER_BASE  + 0x55000)
#define GPIO3_BASE		(OMAP44XX_L4_PER_BASE  + 0x57000)
#define GPIO4_BASE		(OMAP44XX_L4_PER_BASE  + 0x58000)
#define GPIO5_BASE		(OMAP44XX_L4_PER_BASE  + 0x5b000)
#define GPIO6_BASE		(OMAP44XX_L4_PER_BASE  + 0x5d000)
...
#define PRM_DSS_BASE		(PRM_BASE + 0x1100)
#define PRM_DEVICE_BASE		(PRM_BASE + 0x1B00)

#define PRM_RSTCTRL		(PRM_DEVICE_BASE + 0x0)
#define PRM_RSTCTRL_RESET	0x01

#define PRM_RSTST		(PRM_DEVICE_BASE + 0x4)
#define PM_DSS_PWRSTCTRL	(PRM_DSS_BASE + 0x0)

/* CM2 Instance */
#define L3INIT_CM2_BASE		0x4A009300
#define CM_L3INIT_HSUSBOTG_CLKCTRL	(L3INIT_CM2_BASE + 0x60)

/* CM2 Instance */
#define DSS_CM2_BASE		0x4A009100
#define CM_DSS_CLKSTCTRL	(DSS_CM2_BASE + 0x0)
#define CM_DSS_DSS_CLKCTRL	(DSS_CM2_BASE + 0x20)
#define CM_DSS_DEISS_CLKCTRL	(DSS_CM2_BASE + 0x28)
