...
#define USB_NET_NAME "USB_Ethernet"
...
/* According to CDC documentation the connection timeout might be up to 10 sec */
/* In the S5PC110 SoC CONFIG_SYS_HZ is 1 ms */
#define USB_CONNECT_TIMEOUT (10000 * CONFIG_SYS_HZ)
