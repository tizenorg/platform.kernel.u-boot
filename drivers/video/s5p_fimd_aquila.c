/*
 * S5PC110 LCD Controller Specific driver for DD Aquila board.
 *
...
void s5pc_c110_gpio_setup(void)
{
	...
	/* set gpio configuration pin for SUB_DISPLAY_CS(MP0_1[2]) */
	...
	/* set gpio configuration pin for SUB_LCD_ON and then to LOW */
	writel(readl(S5PC110_GPIO_BASE(S5PC110_GPIO_MP0_2_OFFSET)) & 0xFFFFFFF0,
		S5PC110_GPIO_BASE(S5PC110_GPIO_MP0_2_OFFSET));
	writel(readl(S5PC110_GPIO_BASE(S5PC110_GPIO_MP0_2_OFFSET)) | 0x00000001,
		S5PC110_GPIO_BASE(S5PC110_GPIO_MP0_2_OFFSET));
	writel(readl(S5PC110_GPIO_BASE(S5PC110_GPIO_MP0_2_OFFSET+4)) & 0xfe,
		S5PC110_GPIO_BASE(S5PC110_GPIO_MP0_2_OFFSET+S5PC1XX_GPIO_DAT_OFFSET));
